...
if (isset($_GET['cid'])) {
    ...
    $query = "SELECT * FROM group5_course WHERE cid='{$_GET['cid']}'";
    $result = mysqli_fetch_assoc(mysqli_query($conn, $query));
    $_SESSION["cname"] = $result["cname"];
    $_SESSION["cid"] = $result["cid"];
    $_SESSION["style"] = "display: none";
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <!-- the home page of a course is a markdown file -->
                <div class="row">
                    <div class="col-xs-10 col-xs-offset-1">
                        <div id="showdown" style="display: none;"><?php
                            $filepath = './assets/courses/' . $_SESSION["cname"] . '/home.md';
                ...
                <!-- upload a new file to substitute the old file -->
                <div class="row">
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $('#showdown').html(html);
        $('#showdown').show();
        // uploaded file must be markdown
        $('#file').ace_file_input({
            allowExt: ['md'],
