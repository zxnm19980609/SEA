            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-10 col-xs-offset-1">
                        <div id="showdown" style="display: none;"><?php
                            $filepath = './assets/reading/' . $_GET["rid"] . '.md';
                ...
                <div class="row">
                    <div class="col-xs-2 col-xs-offset-5"
                         style='<?php if ($_SESSION["role"] != 1) echo "display: none"; else echo ""; ?>'>
                        <form action='<?php echo "upload_reading.php?rid=" . $_GET["rid"] ?>' method="post"
