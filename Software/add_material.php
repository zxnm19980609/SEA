...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Add Material - Canvas</title>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action='<?php echo "add_material_info.php?".$_SERVER["QUERY_STRING"] ?>' method="post">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Material Title" name="name"/>
