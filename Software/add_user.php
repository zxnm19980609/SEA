								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="add_user_info.php" method="post">
												<fieldset>

													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="User Name" name="uname"/>
                                                            <font color="#FF0000"> hint: User name contains at least 8 characters; </font>
                                                    ...
                                                    <label class="block clearfix">
														<span class="block input-icon input-icon-right">
                                                            ...
                                                            <font color="#FF0000"> hint: password contains only digits and letters; </font>
                                                    ...
                                                    <label class="block clearfix">
														<div>
                                                            <select name="role" style="width:350px">
